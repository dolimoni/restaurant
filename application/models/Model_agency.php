...
class model_agency extends CI_Model {
    ...
    {
        $this->db->select('sh.id as sh_id,p.id as p_id,p.name,a.name as a_name,p.name as p_name,sh.type,sh.quantity,sh.removal,p.min_quantity,p.totalQuantity,Date(sh.created_at) as date');
