...
class Provider extends BaseController
{
    ...
    public function statistic()
    {
        ...
        $data["ordersToPay"]=$this->model_provider->getProvidersToPay();
    ...
    public function apiStatistic(){
        ...
        try {
            ...
            $response["report"]["ordersToPay"] = $this->model_provider->getProvidersToPay($startDate, $endDate);
            $response["report"]["ordersToPayAmount"] = array_sum(array_column($response["report"]["ordersToPay"],'amount'));
            $this->output
                ->set_content_type("application/json")
    ...
    public function apiGetQuotation()
    {
        ...
        $this->output
            ->set_content_type("application/json")
            ->set_output(json_encode(array('status' => 'success', 'quotation' => $quotation)));
        $this->log_end(array('status' => 'success', 'quotation' => $quotation));
    }
    ...
    public function apiGetOrder()
    {
        ...
        $this->output
            ->set_content_type("application/json")
            ->set_output(json_encode(array('status' => 'success', 'order' => $order, 'orderStatus' => $orderStatus)));
        $this->log_end(array('status' => 'success', 'order' => $order, 'orderStatus' => $orderStatus));
    }
    ...
    function apiPrintOrder()
    {
        ...
        $data['order'] = $order;
        $data['order_config'] = $this->model_order->config();
        $output = $this->createPDF($data);
        $this->output
            ->set_content_type("application/json")
            ->set_output(json_encode(array('status' => 'success', 'filepath' => $output,'fullfilepath'=>base_url($output))));
        $this->log_end(array('status' => 'success', 'filepath' => $output));
    }
    ...
    function order()
    {
        ...
        $this->output
            ->set_content_type("application/json")
            ->set_output(json_encode(array('status' => 'success', 'filepath' => $output,'fullfilepath'=>base_url($output), 'emailStatus' => $emailStatus)));
        $this->log_end(array('status' => 'success', 'filepath' => $output, 'emailStatus' => $emailStatus));
    }
    ...
    public function apiFilterOrders(){
        $this->log_begin();
        try {
            $id = $this->input->post('id');
            $startDate = $this->input->post('startDate');
            $endDate = $this->input->post('endDate');
            $orders=$this->model_provider->getOrders($id, $startDate,$endDate);
            $this->output
                ->set_content_type("application/json")
                ->set_output(json_encode(array('status' => 'success','orders'=>$orders)));
            $this->log_end(array('status' => 'success'));
        } catch (Exception $e) {
