...
class LocalAgency extends BaseController
{
    ...
    public function __construct()
    {
        ...
        $this->load->model('model_localagency');
    ...
    {
        $this->log_begin();
        $aa=$this->model_localagency->getCurrentDb();
        $data['agencies'] = $this->model_localagency->getAll();
        $data['params'] = $this->getParams();
        $this->load->view('admin/agency/local/view_agencies', $data);
        $this->log_end($data);
    }
     ...
     public function addProducts(){
        ...
        $data['params'] = $this->getParams();
        $this->load->view('admin/agency/local/view_addProducts', $data);
        $this->log_end($data);
    }
    ...
    public function historyProducts()
    {
        ...
        $data['products'] = $this->model_localagency->getProductsHistory();
        $data['productsList'] = $this->model_product->getAll(false, true);
        $data['productsList'] = $this->sortListByName($data['productsList']);
        $data['agencies'] = $this->model_localagency->getAll();
        $data['params'] = $this->getParams();
        $this->parser->parse('admin/agency/local/view_historyProducts', $data);
    }
    public function apiFilterHistoryProducts()
    {
        ...
        try {
            $data['products'] = $this->model_localagency->getProductsHistory($agency,$groupProducts,$startDate,$endDate);
            $this->output
    ...
    {
        $data['params'] = $this->getParams();
        $agency= $this->model_localagency->getAgency($id);
        $data["agency"]= $agency;
        ...
        if($agency["type"]==="master"){
            ...
            $data['products'] = $this->model_localagency->getProducts($id);
        }else{
    ...
    public function apiAddStock(){
        ...
        try {
            ...
            $this->model_localagency->addStock($stock);
    ...
    public function apiEditAgency()
    {
        try {
            ...
            $this->model_localagency->editAgency($id, $agency);
    ...
    public function apiEditStockHistory()
    {
        try {
            ...
            $response = $this->model_localagency->editStockHistory($stock_history["id"], $stock_history["quantity"]);
            $this->output
                ->set_content_type("application/json")
    ...
    public function apiDeleteStock()
    {
        try {
            ...
            $response = $this->model_localagency->deleteStockHistory($stock_history_id);
            $this->output
                ->set_content_type("application/json")
                ->set_output(json_encode($response));
        } catch (Exception $e) {
    ...
    public function statistic()
    {
        ...
        $data['agencies'] = $this->model_localagency->getAll(true);
    ...
    public function apiActivate(){
        ...
        try {
            $id = $this->input->post('id');
            $this->model_localagency->setCurrentAgency($id);
            $this->output
                ->set_content_type("application/json")
                ->set_output(json_encode(array('status' => "success")));
        } catch (Exception $e) {
