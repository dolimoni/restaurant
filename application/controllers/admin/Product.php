...
class Product extends BaseController {
    ...
    public function add()
    {
       $this->log_begin();
       $data['params'] = $this->getParams();
        if ($data['params']["multi_site"]==="false") {
    ...
    public function edit()
	{
        ...
        $data['marks'] = $this->model_mark->getByProduct($id);
		if(!$data['product']){
            redirect('/admin/product/index');
        }
		$data['quantities'] = $this->model_product->getQuantitiesToShow($id);
	...
	public function apiStatistics(){
        try {
            ...
            $report['product_orders']=$this->model_product->getOrders($id,$startDate,$endDate);
            $this->output
                ->set_content_type("application/json")
    ...
    public function apiAddMark(){
        try {
            $this->log_begin();
            $mark = $this->input->post('mark');
            $response = $this->model_mark->add($mark);
            $this->output
                ->set_content_type("application/json")
	...
	public function apiDeleteQuantity()
	{

        try {
            $this->log_begin();
            $quantity = $this->input->post('quantity');
            $response=$this->model_product->deleteQuantity($quantity);
            $this->output
                ->set_content_type("application/json")
                ->set_output(json_encode($response));
            $this->log_end($response);
	...
	public function apiDeleteMark()
	{

        try {
            $this->log_begin();
            $mark = $this->input->post('mark');
            $response=$this->model_mark->delete($mark);
            $this->output
                ->set_content_type("application/json")
                ->set_output(json_encode($response));
            $this->log_end($response);
    ...
    public function apiEditMark()
    {

        try {
            $this->log_begin();
            $mark = $this->input->post('mark');
            $response=$this->model_mark->update($mark);
            $this->output
                ->set_content_type("application/json")
                ->set_output(json_encode($response));
            $this->log_end($response);
