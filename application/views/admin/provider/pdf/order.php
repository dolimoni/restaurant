        ...
        <div class="">
            ...
            <div class="row">
               <!-- <div>
                ...
                <div>Téléphone <span>: 0123456789</span></div>

                <h3>A</h3>-->
                <div>
                        <div style="float: left">
                            <div>Nom : <span><?php echo $order_config['name'] ?></span></div>
                            <div>Entreprise : <span><?php echo $order_config['company'] ?></span></div>
                            <div>Adresse : <span><?php echo $order_config['address'] ?></span></div>
                            <div>Téléphone : <span><?php echo $order_config['phone'] ?></span></div>
                        </div>
                ...
                <div class="text-center">
                    ...
                    Référence: <?php echo $order['reference']; ?>
                    <?php } ?>
                </div>
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <table class="table1">
                        ...
                        <?php foreach ($order['productsList'] as $product ) {
                            $pack='';
                            if($product['pack']==='true' and $product['piecesByPack']>0){
                                $pack=' (Pack de '.$product['piecesByPack'].' pieces)';
                            }
                            ?>
                        <tr>
                            <td><?php echo $product['name'].' '.$product['markName'].$pack; ?></td>
                    ...
                    <table class="table2 text-center" >
                        <tr>
                            ...
                            <td width="23%"><?php echo $order['underTotal'];?> DH</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td ><?php echo $order['discount'] ; ?> DH</td>
                        </tr>
                        <?php } ?>

                        <?php if($order_config['shipping']==='true'){ ?>
                        <tr>
                            <td colspan="4" class="text-right">FRAIS LIVRAISON</td>
                            <td ><?php echo $order['shipping'] ; ?> DH</td>
                        </tr>
                        <?php } ?>
                        <?php if($order_config['other']==='true'){ ?>
                        <tr>
                            <td colspan="4" class="text-right">AUTRE</td>
                            <td ><?php echo $order['other'] ; ?> DH</td>
                        </tr>
                        <?php } ?>
                        <tr>
                            <td colspan="4" class="text-right">TOTAL</td>
                            <td ><?php echo $order['underTotal']*(1+ $order['tva']/100)-$order['discount']; ?> DH</td>
                        </tr>
                        </tbody>
                    </table>
                </div> <!-- /col -->
