    ...
    <div class="productsList">
        ...
        <!--------------------------------------------Products to order Tab------------------------------------------------------>
                                    ...
                                    <div role="tabpanel" class="tab-pane fade" id="tab_productsToOrder"
                                        ...
                                        <input type="button" class="btn btn-info" value="Nouvelle commande"
                                               data-toggle="modal"
...
<script>
    ...
    $('.editOrderModal').on('click',function () {
        $.ajax({
            url: "<?php echo base_url('admin/provider/apiGetOrder'); ?>",
            type: "POST",
            dataType: "json",
            data: {'id': $(this).attr('data-id')},
            success: function (data) {
    ...
    $('button[name=printOrderProducts]').on('click', {url: "admin/provider/apiPrintOrder"}, productsToOrder);

    $("input[type='text'][name='quantity']").keyup({productSelector:'product',quantitySelector:'quantity'},calulProductPrice);
...
<script>
    ...
    function changeStatus(type,newStatus) {
        ...
        switch (newStatus) {
            case 'received':
                $('#changeStatus').empty();
                var b1 = '<button data-toggle="collapse" data-type="pending" href="#changeStatus" type="button" class="btn btn-round btn-info">En attente</button>';
                var b2 = '<button data-toggle="collapse" data-type="canceled" href="#changeStatus" type="button" class="btn btn-round btn-warning">Annulée</button>';
            ...
            case 'canceled':
                $('#changeStatus').empty();
                var b1 = '<button data-toggle="collapse" data-type="received" href="#changeStatus" type="button" class="btn btn-round btn-success">Reçue</button>';
                var b2 = '<button data-toggle="collapse" data-type="pending" href="#changeStatus" type="button" class="btn btn-round btn-info">En attente</button>';
                $('#changeStatus').append(b1);
                $('#changeStatus').append(b2);
            ...
            case 'pending':
                ...
                $('#changeStatus').append(b1);
                $('#changeStatus').append(b2);
                $(".orderActualStatus").html("En attente");
