<div class="modal fade" id="quotationEditModal" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
                                            ...
                                            <div class="controls">
                                                <div class="col-md-11 xdisplay_inputx form-group">
                                                    <input type="text" class="form-control has-feedback-left"
                                                           id="single_cal1" placeholder="Date de réception"
                    ...
                    <form class="form-horizontal addProviderQuotationForm" role="form"  data-id="1">
                        <div class="form-group">
                            <input type="hidden" class="form-control"
                                    name="product_id" placeholder="Nom"/>
                            <label class="col-sm-2 control-label"
            ...
            <div class="modal-footer">
                ...
                <button type="button" id="applyEditProviderQuotation" class="btn btn-primary btn-warning">
                    Appliquer
                </button>
                <button type="button" id="editProviderQuotation" class="btn btn-primary">
                    Modifier
                </button>
            </div>
        </div>
