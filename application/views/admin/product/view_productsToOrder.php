    ...
    <div class="">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        <h2><?= lang("order_should_be_ordered"); ?></h2>
                    ...
                    <div class="x_content table-responsive">
                        <table class="table table-striped">
                            ...
                            <tr class="<?php echo $status; ?>">
                                ...
                                <td>
                                    <a href=" <?php echo base_url('admin/product/edit/'. $product['id']); ?>" class="btn btn-primary btn-xs"><?= lang("edit"); ?></a>
                                    <a class="btn btn-danger btn-xs deleteProduct"
                                       data-id="<?php echo $product['id']; ?>"><?= lang("delete"); ?></a>
