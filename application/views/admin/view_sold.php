		...
		--></div>
						...
						<table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                ...
                                <td><?php echo "Name: ".$vehicle['cf_name']." ".$vehicle['cl_name']."<br>Téléphone :".$vehicle['mobile']."<br>Adresse: ".$vehicle['c_mobile']; ?></td>
                                <td><?php echo $vehicle['manufacturer_name']; ?></td>
                                <td><?php echo $vehicle['model_name']; ?></td>
                                <td><?php echo $vehicle['ttc']; ?></td>
                                <td><?php $date = new DateTime($vehicle['date_livraison']); echo $date->format('m/d/Y'); ?></td>
                                <td><?php $date = new DateTime($vehicle['date_reprise']); echo $date->format('m/d/Y'); ?></td>
