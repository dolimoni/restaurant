                            ...
                            <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td width="20%">
                                            <a href='<?php echo base_url("/admin/reports/viewReport/$id"); ?>'><i class="fa fa-eye fa-2x" aria-hidden="true"></i></a>
                                            <?php if (($this->session->userdata('id') == $report['user_id']) && $report['sent'] ==0) { ?>
                                                <a href="<?php echo base_url("/admin/reports/editReport/$id"); ?>" class="editBtn"><i class="fa fa-pencil fa-2x" aria-hidden="true"></i></a>
                                                <a class="sendBtn"><i class="fa fa-send fa-2x" aria-hidden="true"></i></a>
                                                <a class="deleteBtn" data-toggle="modal" data-target="#myModal" data-id="<?php echo $id; ?>" ><i class="fa fa-trash fa-2x" aria-hidden="true"></i></a>
                                            <?php } ?>
