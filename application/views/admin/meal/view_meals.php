                    ...
                    <div class="x_panel">
                        ...
                        <div class="row">
                            <div class="col-md-3 col-sm-6 col-xs-12">
                                ...
                                <input type="text" placeholder="<?= lang('productsName') ?>" class="form-control" id="searchInput"
                                       onkeyup="myFunction()">
                            </div>
                            <div class="col-md-offset-5 col-md-4 col-sm-6 col-xs-12 text-center">
                                <label for="exampleInputName2"><?= lang('completed_technical_sheet') ?></label>
                        ...
                        <div class="x_content table-responsive">
                            <table id="datatable-responsivee"
                                ...
                                <tr>
                                    ...
                                    <th class="danger"><?= lang('cost_price') ?></th>
