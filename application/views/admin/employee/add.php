    ...
    <div class="productsList">
        <div class="page-title">
            ...
            <div class="title_left">
                <h3><?= lang("employees_list"); ?></h3>
                <label for="exampleInputName2"><?= lang("search"); ?></label>
                <input type="text" placeholder="<?= lang("employee_name"); ?>" class="form-control" id="searchInput"
                       onkeyup="myFunction()">
            </div>
        </div>
        ...
        <div class="article-title">
            <a class="btn btn-primary" data-toggle="collapse" href="#collapseExample" aria-expanded="false"
               aria-controls="collapseExample"><?= lang("new_employee"); ?></a>
            <a class="btn btn-info" href="<?php echo base_url("admin/employee/all"); ?>"><?= lang("employees_list"); ?></a>
        </div>
            ...
            <form id="addEmployeeForm" enctype="multipart/form-data">
                <fieldset>
                    <div class="row">
                        ...
                        <div class="col-xs-4">
                            <br>
                            <label for="prenom"><?= lang("last_name"); ?> :</label>
                    ...
                    <div class="row">
                        <div class="col-xs-4">
                            <br>
                            <label for="name"><?= lang("workType"); ?> :</label>
                    ...
                    <div class="text-right">
                        <input class="btn btn-success" type="submit" name="addEmployee" value="<?= lang("confirme"); ?>"/>
                    </div>
            ...
            <form id="editProviderForm" enctype="multipart/form-data">
                <fieldset>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-4">
                            <br>
                            <label for="name"><?= lang("salary"); ?> :</label>
                            <input type="text" class="form-control" name="salary"
                                   placeholder="<?= lang("salary"); ?>"
                            >
                        </div>
                    ...
                    <div class="row">
                        <div class="col-xs-4">
                            <br>
                            <label for="workType"><?= lang("workType"); ?> :</label>
                            <input type="text" class="form-control" name="workType">
                        </div>
                        ...
                        <div class="col-sm-12 profile_details-link" data-id="<?php echo $employee['id']; ?>">
                            ...
                            <div class="left col-xs-12">
                                <ul class="list-unstyled">
                                    <li><i class="fa fa-building"></i> <?= lang("address"); ?>: <?php echo $employee['address']; ?>
                                    </li>
                                    <li><i class="fa fa-phone"></i> <?= lang("telphone"); ?> #:<?php echo $employee['phone']; ?></li>
                                </ul>
                            </div>
                        </div>
