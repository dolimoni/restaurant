    ...
    <div class="productsList">
        ...
        <div class="row mealComposition">
            ...
            <div class="col-md-6  col-sm-6 col-xs-12 product" data-id="<?php echo $key+1; ?>" >
                                <?php
                                $q1= $mealItem['quantityInMagazin'];
                                $q2= $mealItem['quantityToSale'];
                                $q3= $mealItem['brokenQuantity'];
                                $q4= $mealItem['notSoldQuantity'];
                                ?>
                                <input type="hidden" name="quantity_id" value="<?php echo $mealItem['sm_id']; ?>">
                                <input type="hidden" name="brokenQuantityNow" value="<?php echo $q3; ?>">
                                <input type="hidden" name="notSoldQuantityNow" value="<?php echo $q4; ?>">
                                   ...
                                   <div class="x_content oldContent" style="margin-top:30px;">
                                       ...
                                       <div class="row tile_count" style="margin-bottom:10px;">
                                           <div class="col-md-3 col-sm-6 col-xs-12 tile_stats_count">
                                               ...
                                               <div class="count"><?php echo $q1; ?></div>
                                               <!--<span class="count_bottom"><i class="green">4% </i> From last Week</span>-->
                                           </div>
                                           <div class="col-md-3 col-sm-6 col-xs-12 tile_stats_count">
                                               <span class="count_top"><i class=""></i>Quantité vente</span>
                                               <div class="count green"><?php echo $q2; ?></div>
                                               <!--<span class="count_bottom"><i class="green">4% </i> From last Week</span>-->
                                           </div>
                                           <div class="col-md-3 col-sm-6 col-xs-12 tile_stats_count">
                                               <span class="count_top"><i class=""></i>Cassée</span>
                                               <div class="count red"><?php echo number_format($q3,0); ?></div>
                                               <!--<span class="count_bottom"><i class="green">4% </i> From last Week</span>-->
                                           </div>
                                           <div class="col-md-3 col-sm-6 col-xs-12 tile_stats_count">
                                               <span class="count_top"><i class=""></i>Non vendu</span>
                                               <div class="count"><?php echo number_format($q4,0); ?></div>
                                               <!--<span class="count_bottom"><i class="green">4% </i> From last Week</span>-->
                                           </div>
                                       </div>
                                       <div class="row">
...
<script>
    ...
    var magazin_id=<?php echo $magazin['id']; ?>;
    var department_id=<?php echo $magazin['department']; ?>;
