    ...
    <div class="right_col" role="main">
        <div class="">
            ...
            <div class="page-title">
                <div class="">
                    <h3><?= lang('manual_synchronization'); ?></h3>
                </div>
            </div>
            ...
            <div class="row">
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-4" <?php echo $hidden; ?>>
                        <label for="paiementDate"><?= lang('report_date'); ?> :</label>
                            ...
                            <table class="table table-striped table-bordered">
                                ...
                                <?php foreach ($sales as $sale){ ?>
                                    <tr class="validate">
                                        ...
                                        <td>
                                            <div class="mealQuantity" data-type="quantity" contenteditable><?php echo $sale["quantity"] ?></div>
                                        </td>
                                        <td>
                                            <div class="mealAmount" data-type="amount" data-sellPrice="<?php echo $sale["sellPrice"] ?>" contenteditable><?php echo $sale["total"] ?></div>
                                        </td>
                                    </tr>
                                <?php } ?>
                                <tr class="mealModel" hidden>
                                    ...
                                    <td>
                                        <div class="mealQuantity" data-type="quantity" contenteditable></div>
                                    </td>
                                    <td>
                        ...
                        <div class="x_content table-responsive">
                            <table id="datatable-responsivee"
                                ...
                                <tr>
                                    ...
                                    <th><?= lang('name'); ?></th>
                                    <th><?= lang('price'); ?></th>
                                    <th class="danger"><?= lang('cost_price'); ?>t</th>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $('#productBody').on('keyup', 'div[data-type=quantity]', function() {
            var quantity=$(this).html();
            var unit_price=$(this).closest('tr').find('div[data-type=amount]').attr('data-sellPrice');
            $(this).closest('tr').find('div[data-type=amount]').html(quantity*unit_price);
        });
                ...
                success: function (data) {
                    if(data.status==="success"){
                        if(data.meal.length){
                            ...
                            tr.find("div[data-type=amount]").attr('data-sellPrice',data.meal[0].sellPrice);
                        }
                    }
                },
                error: function (data) {
