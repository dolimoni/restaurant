...
(function () {
    ...
    x.Chart = function () {
        ...
        q.prototype._touchEventHandler = function (a) {
            if (a.changedTouches && this.interactivityEnabled) {
                ...
                switch (a.type) {
                    ...
                    case "touchend":
                    case "MSPointerUp":
                        f = "touchstart" === this._lastTouchEventType || "MSPointerDown" === this._lastTouchEventType ?
                ...
                if (!(b && 1 < b.length)) {
                    ...
                    if (this._lastTouchData.scroll && this.zoomEnabled) this.isDrag && this.resetOverlayedCanvas(), this.isDrag = !1; else for (b = 0; b < f.length; b++)e = f[b], g = document.createEvent("MouseEvent"), g.initMouseEvent(e,
        ...
        q.prototype._dispatchRangeEvent = function (a, f) {
            ...
            for (var e = 0; e < c.length; e++)if (y(b[c[e]]) && (b[c[e]] = []),
                "axisY" === c[e])for (var g = 0; g < this.axisY.length; g++)b[c[e]].push({
            ...
            if (this.interactivityEnabled)if (this._ignoreNextEvent) this._ignoreNextEvent =
                ...
                if (!q.capturedEventParam && this._events) {
                    for (var g = 0; g < this._events.length; g++)if (this._events[g].hasOwnProperty(b))if (c = this._events[g], e = c.bounds, f.x >= e.x1 && f.x <= e.x2 && f.y >= e.y1 && f.y <= e.y2) {
                        ...
                        "mousedown" === b && !0 === c.capture ? (q.capturedEventParam = c, this.overlaidCanvas.setCapture ? this.overlaidCanvas.setCapture() : document.documentElement.addEventListener("mouseup", this._mouseEventHandler,
        ...
        q.prototype._plotAreaMouseUp = function (a, f) {
            ...
            if ("none" !== this.plotInfo.axisPlacement) {
                this.resetOverlayedCanvas();
                if (this.axisX && 0 < this.axisX.length)for (h = 0; h < this.axisX.length; h++)this.axisX[h].crosshair &&
                ...
                if (this.axisY2 && 0 < this.axisY2.length)for (h = 0; h < this.axisY2.length; h++)this.axisY2[h].crosshair && this.axisY2[h].crosshair.enabled &&
        ...
        q.prototype._plotAreaMouseMove = function (a, f) {
            if (this.isDrag && "none" !== this.plotInfo.axisPlacement) {
                ...
                if ((!e ||
                    2 < Math.abs(b) || !g || 2 < Math.abs(c)) && (this.panEnabled || this.zoomEnabled))if (this.panEnabled) e = {
        ...
        q.prototype.validateRegion = function (a, f, b, c, e) {
            ...
            for (h = 0; h < k.length; h++) {
                ...
                if (isFinite(p.dataInfo.minDiff))if (w = p.getApparentDifference(n, d, null, !0), !(g || !(this.panEnabled && p.scaleBreaks && p.scaleBreaks._appliedBreaks.length) && (p.logarithmic && w < Math.pow(p.dataInfo.minDiff, 3) || !p.logarithmic && w < 3 * Math.abs(p.dataInfo.minDiff)) || n < p.minimum || d > p.maximum)) t.push(p),
                    r.push({val1: n, val2: d}), l = !0; else if (!e) {
                    l = !1;
                    break
                }
            }
        ...
        q.prototype.renderIndexLabels = function (a) {
            ...
            for (a = 0; a < this._indexLabels.length; a++) {
                var k = this._indexLabels[a], r = k.chartType.toLowerCase(), p, n, l = na("indexLabelFontColor",
                    k.dataPoint, k.dataSeries), t = na("indexLabelFontSize", k.dataPoint, k.dataSeries);
        ...
        q.prototype.renderStepLine = function (a) {
            var f =
                a.targetCanvasCtx || this.plotArea.ctx, b = v ? this._preRenderCtx : f;
            if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        q.prototype.renderSpline = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var h = [], l = 0; l < a.dataSeriesIndexes.length; l++) {
                    ...
                    var D = 0, u, S, q = [];
                    c.beginPath();
                    if (0 < r.length)for (S = !1, D = 0; D < r.length; D++)if (u = r[D].getTime ? r[D].x.getTime() : r[D].x, !(u < a.axisX.dataInfo.viewPortMin || u > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !S)))if ("number" !== typeof r[D].y) 0 < D && !S && (k.connectNullData ? c.setLineDash && (0 < q.length && (k.options.nullDataLineDashType || !r[D - 1].lineDashType)) && (q[q.length -
                    ...
                    if (0 < u.length) {
                        ...
                        for (k = 0; k < u.length; k++)if (c = u[k].x.getTime ? u[k].x.getTime() : u[k].x, !(c < a.axisX.dataInfo.viewPortMin || c > a.axisX.dataInfo.viewPortMax) && "number" === typeof u[k].y) {
                            ...
                            if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < u[k].y) l[c] = u[k].y + (l[c] ? l[c] : 0), 0 < l[c] && (p = a.axisY.convertValueToPixel(l[c]),
                                B = "undefined" !== typeof g[c] ? g[c] : n, g[c] = p); else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= u[k].y) t[c] = u[k].y + (t[c] ? t[c] : 0), B = a.axisY.convertValueToPixel(t[c]), p = "undefined" !== typeof h[c] ? h[c] : n, h[c] = B; else if (p = a.axisY.convertValueToPixel(u[k].y), 0 <= u[k].y) {
                            ...
                            V(b, s, p, y, B, c, 0, null, q && 0 <= u[k].y, 0 > u[k].y && q, !1,
                                !1, D.fillOpacity);
                            c = D.dataPointIds[k];
                            this._eventManager.objectMap[c] = {
                                id: c,
        ...
        q.prototype.renderStackedColumn100 = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var w = 0; w < a.dataSeriesIndexes.length; w++) {
                    ...
                    if (0 < u.length)for (var q = 5 < d && D.bevelEnabled ?
                ...
                for (var w = 0; w < a.dataSeriesIndexes.length; w++) {
                    ...
                    if (0 < u.length) {
                        ...
                        for (k = 0; k < u.length; k++)if (c = u[k].x.getTime ? u[k].x.getTime() : u[k].x, !(c < a.axisX.dataInfo.viewPortMin || c > a.axisX.dataInfo.viewPortMax) && "number" === typeof u[k].y) {
                            ...
                            else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= u[k].y) t[c] = u[k].y + (t[c] ? t[c] : 0), r = h[c] ? h[c] : n, h[c] = B = a.axisY.convertValueToPixel(t[c]); else if (r = a.axisY.convertValueToPixel(u[k].y), 0 <= u[k].y) {
                                var A = g[c] ? g[c] : 0;
                                B = n + A;
                                r += A;
                                g[c] = A + (r - B)
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var w = 0; w < a.dataSeriesIndexes.length; w++) {
                    ...
                    if (0 < u.length) {
                        var q = 5 < d && D.bevelEnabled ? !0 : !1;
                        b.strokeStyle = "#4572A7 ";
                        for (k = 0; k < u.length; k++)if (c = u[k].x.getTime ? u[k].x.getTime() : u[k].x,
                            ...
                            if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < u[k].y) {
                                ...
                                0 >= u[k].y) t[c] = s + (t[c] ? t[c] : 0), r = h[c] ? h[c] : n, h[c] = s = a.axisY.convertValueToPixel(t[c]); else if (r = a.axisY.convertValueToPixel(s), 0 <= u[k].y) {
                                var A = g[c] ? g[c] : 0;
                                s = n + A;
                                r += A;
                                g[c] = A + (r - s)
        ...
        q.prototype.renderArea =
            function (a) {
                ...
                var e = a.targetCanvasCtx || this.plotArea.ctx, g = v ? this._preRenderCtx :
                    e;
                if (!(0 >= a.dataSeriesIndexes.length)) {
                    var h = this._eventManager.ghostCtx, l = a.axisX.lineCoordinates, t = a.axisY.lineCoordinates,
                        k = [], r = this.plotArea, p;
                    g.save();
                    v && h.save();
                    g.beginPath();
                    ...
                    for (var n = 0; n < a.dataSeriesIndexes.length; n++) {
                        ...
                        f = !0;
                        var D = 0, u, s, q,
                            y = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), B,
                            A = null;
                        if (0 < m.length) {
                            var x = w._colorSet[D % w._colorSet.length], z = w.lineColor = w.options.lineColor || x,
                                J = z;
                            g.fillStyle = x;
                            g.strokeStyle = z;
                            ...
                            for (var ea = !0; D < m.length; D++)if (q = m[D].x.getTime ? m[D].x.getTime() : m[D].x, !(q < a.axisX.dataInfo.viewPortMin ||
            ...
            function f() {
                ...
                if (0 < b.length) {
                    if (0 < p.lineThickness) {
                        ...
                        for (var d = 0; d < b.length - 3; d += 3)if (c.bezierCurveTo(b[d + 1].x, b[d + 1].y, b[d + 2].x, b[d + 2].y, b[d + 3].x, b[d + 3].y), v && e.bezierCurveTo(b[d + 1].x, b[d + 1].y, b[d + 2].x, b[d + 2].y, b[d + 3].x, b[d + 3].y), b[d + 3].newStrokeStyle || b[d + 3].newLineDashArray) c.stroke(), c.beginPath(),
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var k = 0; k < a.dataSeriesIndexes.length; k++) {
                    ...
                    if (0 < n.length) {
                        ...
                        for (m = !1; d < n.length; d++)if (w = n[d].x.getTime ? n[d].x.getTime() : n[d].x, !(w < a.axisX.dataInfo.viewPortMin || w > a.axisX.dataInfo.viewPortMax && (!p.connectNullData || !m)))if ("number" !== typeof n[d].y) 0 < d && !m && (p.connectNullData ? c.setLineDash && (0 < q.length && (p.options.nullDataLineDashType || !n[d - 1].lineDashType)) &&
                    ...
                    if (0 < m.length) {
                        ...
                        if (g.setLineDash) {
                            var da = G(w.nullDataLineDashType, w.lineThickness),
                                I = w.lineDashType, ea = G(I, w.lineThickness);
                            g.setLineDash(ea)
                        }
        ...
        q.prototype.renderStackedArea = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var e = [], x = 0; x < a.dataSeriesIndexes.length; x++) {
                    var B =
                        a.dataSeriesIndexes[x], A = this.data[B], z = A.dataPoints;
                    A.dataPointIndexes = [];
                ...
                for (x = 0; x < a.dataSeriesIndexes.length; x++) {
                    ...
                    s.fillStyle = p;
                    if (0 < k.length) {
                        var e = A._colorSet[0], L = A.lineColor = A.options.lineColor || e, J = L;
                        c.fillStyle = e;
                        c.strokeStyle = L;
                        ...
                        for (var ea = !0, p = 0; p < k.length; p++) {
                            ...
                            if (!(w < a.axisX.dataInfo.viewPortMin || w > a.axisX.dataInfo.viewPortMax && (!A.connectNullData || !ea)))if ("number" !== typeof $.y) A.connectNullData || (ea || q) || f(), ea = !0; else {
        ...
        C.setLayoutAndRender = function (a, f, b, c, e, g) {
            ...
            p.restore();
            if (a && 0 < a.length)for (d = 0; d < a.length; d++)a[d].renderGrid(), v &&
        ...
        C.prototype.renderStripLinesOfThicknessType = function (a) {
            if (this.stripLines && 0 < this.stripLines.length &&
                ...
                for (c = 0; c < this._stripLineLabels.length; c++)if (k = this.stripLines[c], b = this._stripLineLabels[c], !(b.position < this.viewportMinimum || b.position > this.viewportMaximum || isNaN(this.range))) {
                    ...
                    if ("outside" === b.stripLine.labelPlacement)if (k &&
